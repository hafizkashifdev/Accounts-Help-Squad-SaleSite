      ...
      <Container maxWidth="xl" sx={{}}>
        ...
        >
          <Grid item lg={4} md={6} xs={12}>
            ...
            >
              <Image src={teamceo} alt="team ceo" />
            </Box>
          </Grid>
          ...
          >
            ...
            >
              ...
              founder behind Accounts Help Squad. With a deep passion for
              finance and a commitment to simplifying complex financial
              processes, Usman embarked on this journey to empower businesses of
              all sizes.
            </Typography>
            <Typography
              sx={{
