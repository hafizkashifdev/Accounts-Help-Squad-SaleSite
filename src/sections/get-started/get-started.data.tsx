...
export const getStartedFormSchema: any = Yup.object().shape({
  ...
  email: Yup.string()
    ...
    .test("Validate Email", "Please Provide Valid Email", (value) => {
      const re =
...
export const getStartedFormFieldsDataFunction = (isFieldDisable = false) => [
  ...
  },
  {
    ...
    componentProps: {
      ...
      placeholder:
        "Please provide any other comments, questions, or specific details about your requirements.",
      multiline: true,
      rows: 3,
      disabled: isFieldDisable,
    },
